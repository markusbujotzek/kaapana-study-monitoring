...
CREDENTIALS_POSTGRES_NOTIFICATIONS_PASSWORD="{{ credentials_postgres_notifications_password|default('Kaapana2020', true) }}"
...
function deploy_chart {
    ...
    --set-string global.credentials_postgres_notifications_password="$CREDENTIALS_POSTGRES_NOTIFICATIONS_PASSWORD" \
